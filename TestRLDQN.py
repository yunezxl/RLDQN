from EnvTest import Re_Environment
...
class load_RLDQN():
    ...
    def Test(self):
        AvgReward_RLDQN_DRO = []
        Feature_Order = []
        agent = RLDQN(self.CaseParams, [None,None], self.demand, self.RLDQNHyparams, self.DisType)
        agent.epsilon = 0
        RLDQN_name = "RLDQN_" + str(self.TrainSampleSize) + '_' + self.DisType + '_' + 'C=' + str(self.c) + '.h5'
